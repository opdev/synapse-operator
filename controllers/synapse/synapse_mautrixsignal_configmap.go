...
func (r *SynapseReconciler) configMapForMautrixSignalCopy(
	s *synapsev1alpha1.Synapse,
	objectMeta metav1.ObjectMeta,
) (client.Object, error) {
	var copyConfigMap *corev1.ConfigMap

	sourceConfigMapName := s.Spec.Bridges.MautrixSignal.ConfigMap.Name
	sourceConfigMapNamespace := r.getConfigMapNamespace(*s, s.Spec.Bridges.MautrixSignal.ConfigMap.Namespace)
...
func (r *SynapseReconciler) updateMautrixSignalData(
	s synapsev1alpha1.Synapse,
