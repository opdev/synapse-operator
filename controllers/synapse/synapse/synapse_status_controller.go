...
// SynapseStatusReconciler reconciles a Synapse object
type SynapseStatusReconciler struct {
	client.Client
...
func (r *SynapseStatusReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	log.Info("Start reconciling Synapse Status")
	...
	log.Info("Finished reconciling Synapse Status successfully")

	return subreconciler.Evaluate(subreconciler.DoNotRequeue())
}

func (r *SynapseStatusReconciler) setStatusHomeserverConfiguration(ctx context.Context, req ctrl.Request) (*ctrl.Result, error) {
	log := ctrllog.FromContext(ctx)

	log.Info("Start setting Homeserver section in Synapse Status")
	...
	log.Info("Finished setting Homeserver section in Synapse Status successfully")

	return subreconciler.ContinueReconciling()
}

func (r *SynapseStatusReconciler) isPostgresOperatorInstalled(ctx context.Context) bool {
...
func (r *SynapseStatusReconciler) updateSynapseStatusWithPostgreSQLInfos(ctx context.Context, req ctrl.Request) (*ctrl.Result, error) {
	log := ctrllog.FromContext(ctx)

	log.Info("Start fetching DB conection information from PostgreSQL secret")
	...
	log.Info("Finished fetching DB conection information from PostgreSQL secret successfully")

	return subreconciler.ContinueReconciling()
}

func (r *SynapseStatusReconciler) updateSynapseStatusDatabase(
	s *synapsev1alpha1.Synapse,
...
func (r *SynapseStatusReconciler) setSynapseStatusAsRunning(ctx context.Context, req ctrl.Request) (*ctrl.Result, error) {
	log := ctrllog.FromContext(ctx)
...
func (r *SynapseStatusReconciler) updateSynapseStatusBridges(ctx context.Context, req ctrl.Request) (*ctrl.Result, error) {
	log := ctrllog.FromContext(ctx)

	log.Info("Start checking for Bridges referencing this Synapse instance")
	...
	log.Info("Finished checking for Bridges referencing this Synapse instance successfully")

	return subreconciler.ContinueReconciling()
}

// SetupWithManager sets up the controller with the Manager.
func (r *SynapseStatusReconciler) SetupWithManager(mgr ctrl.Manager) error {
