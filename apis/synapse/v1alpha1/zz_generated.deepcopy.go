...
func (in *SynapseMautrixSignalConfigMap) DeepCopy() *SynapseMautrixSignalConfigMap {
	...
	out := new(SynapseMautrixSignalConfigMap)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SynapseStatusMautrixSignal) DeepCopyInto(out *SynapseStatusMautrixSignal) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SynapseStatusMautrixSignal.
func (in *SynapseStatusMautrixSignal) DeepCopy() *SynapseStatusMautrixSignal {
	if in == nil {
		return nil
	}
	out := new(SynapseStatusMautrixSignal)
	in.DeepCopyInto(out)
	return out
}
