...
# quay.io/opdev/synapse-operator-bundle:$VERSION and quay.io/opdev/synapse-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/opdev/synapse-operator
...
KIND_CLUSTER ?= synapse-operator-test-e2e
